...
$scores = getCompetitionScores($pdo, $mareos_id, $view, $start_date, $end_date);
$avg_stats = getAverageStats($pdo, $mareos_id, $view, $start_date, $end_date);
$best_lowest_stats = getBestAndLowestStats($pdo, $mareos_id, $view, $start_date, $end_date);
$monthly_competition_data = getMonthlyCompetitionData($pdo, $mareos_id, $view);
