<?php
$title = 'Athletes Competition Scoring';
...
<div class="main-content" id="mainContent">
    ...
    <div class="row bg-dark text-white py-4 mb-5" style="border-radius: 10px;">
        <div class="col">
            <h3 class="m-0">Athletes Competition Scoring Dashboard</h3>
        </div>
    </div>
...
function fetchTournamentScores(tournamentId) {
    return fetch(`<?php echo COMP_SCORE_URL; ?>?tournament_code=${tournamentId}`)
        .then(response => response.json())
        .then(data => {
